...
function MeteorStrike({ onExit }) {
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, background: BG, zIndex: 9999 }}>
      ...
      <button onClick={onExit} style={{ position: 'absolute', top: 12, right: 20, background: 'transparent', border: `1px solid #7c2d12`, color: '#7c2d12', padding: '4px 12px', cursor: 'pointer', fontFamily: '"Share Tech Mono", monospace', fontSize: 10, letterSpacing: '0.1em', zIndex: 1 }}>EXIT</button>
