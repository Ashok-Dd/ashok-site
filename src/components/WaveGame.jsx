...
function DeepDive({ onExit }) {
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, background: BG, zIndex: 9999 }}>
      ...
      <button onClick={onExit} style={{ position: 'absolute', top: 12, right: 20, background: 'transparent', border: `1px solid #1e3a5f`, color: '#1e3a5f', padding: '4px 12px', cursor: 'pointer', fontFamily: '"Share Tech Mono", monospace', fontSize: 10, letterSpacing: '0.1em', zIndex: 1 }}>EXIT</button>
